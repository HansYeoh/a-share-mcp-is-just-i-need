...
if __name__ == "__main__":
    logger.info(
        f"Starting A-Share MCP Server via streamable-http at http://0.0.0.0:8000/mcp ... Today is {current_date}")
    # Run the server using Streamable HTTP transport; endpoint is /mcp
    app.run(
